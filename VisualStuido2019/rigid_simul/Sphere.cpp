...
Sphere::Sphere(){
    ...
    //initial physical value setting
...
void Sphere::step(){
    ...
    checkCollision(newvelocity,newposition); //collision check with cube
...
void Sphere::checkCollision(glm::vec3& newvelocity, glm::vec3& newposition){
    ...
    //collision check with cube

    
    // interpolating (penetration solved)
